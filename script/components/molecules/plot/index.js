...
import { any as IsAny } from 'prop-types';
...
export const Plot = ({ model }) => {
    ...
    return (React.createElement("div", { className: "plot" },
        React.createElement("div", { className: "actions" },
            ...
            React.createElement("select", { onChange: handleTypeChange },
            ...
            React.createElement("select", { onChange: handleAverageChange },
        ...
        React.createElement(ResponsiveContainer, { aspect: 21 / 9 },
            React.createElement(ComposedChart, { data: plotData, margin: { top: 5, right: 30, left: 20, bottom: 5 } },
